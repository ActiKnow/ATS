  ...
  public  class ATSDBInitializer : CreateDatabaseIfNotExists<ATSDBContext>
    {
        protected override void Seed(ATSDBContext context)
        {
            ...
            context.TypeDef.Add(new Model.TypeDef { TypeId = Guid.NewGuid(), Description = "Test Type", Value = (int)CommonType.TESTTYPE, ParentKey = 0, CreatedBy = "Admin", CreatedDate = DateTime.Now });
            //Question Type
